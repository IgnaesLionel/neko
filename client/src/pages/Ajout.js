      ...
      <div>
        ...
        <form className="ajout" onSubmit={handleSubmit}>
          ...
          <select
            name="Cats"
            id="Cats-select"
            onChange={(e) => setokWithCats(e.target.value)}
          >
          ...
          <select
            name="Dogs"
            id="Dogs-select"
            onChange={(e) => setokWithDogs(e.target.value)}
          >
            <option value="idk"> Je ne sais pas</option>
            <option value="yes">oui</option>
            <option value="non">no</option>
          ...
          <select
            name="Child"
            id="Child-select"
            onChange={(e) => setokWithChild(e.target.value)}
          >
            <option value="idk"> Je ne sais pas</option>
            <option value="yes">oui</option>
            <option value="non">no</option>
          ...
          />
          <label htmlFor="char6" className="form-check-label">
            {" "}
