...
const Home = (props) => {
    return (
        <div>
             ...
             <header>  
                 <h1 id="homefont"><strong>Adoption</strong> d'animaux ! ces <strong>chats</strong> ou <strong>chiens</strong> recherchent une famille, un foyer a aimer ! </h1>
           ...
           <h2 id="homefont"> Chats érrants ou maltraités, ces animaux ont besoin de vous pour une adoption! </h2>
